...
import { getBloodbankDonateStates } from '../../store/donateStatesSlice'
import { getBloodbankReceiveStates } from '../../store/receiveStatesSlice'
...
const BloodbankHome = () => {
	...
	useEffect(() => {
		dispatch(getBloodbankDonateStates())
		dispatch(getBloodbankReceiveStates())
	}, [dispatch])
				...
				<Grid item xs={6}>
					<Card sx={{ backgroundColor: 'transparent' }}>
						...
						<CardActions>
							<Button
								onClick={() =>
									navigate('/bloodbank/donaterequestsstates')
								}
							>
								Learn More
							</Button>
				...
				<Grid item xs={6}>
					<Card sx={{ backgroundColor: 'transparent' }}>
						...
						<CardActions>
							<Button
								onClick={() =>
									navigate('/bloodbank/receiverequestsstates')
								}
							>
								Learn More
							</Button>
